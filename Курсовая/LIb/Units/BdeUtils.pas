...
uses Forms, Controls, Dialogs, {$IFDEF RX_D6}RTLConsts{$ELSE}Consts{$ENDIF},
  DBConsts, RXDConst, VCLUtils,
  FileUtil, RxAppUtils, RxStrUtils, MaxMin, {$IFNDEF WIN32} Str16, {$ENDIF}
